...
public class DemoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        Article ar = dao.getArticleByID(id);

        if (author_id == ar.getAuthor_id() || role == 0) {
            List<Comment> list = dao.getTop3CommentByID(article_id);

            request.setAttribute("top3comment", list);
