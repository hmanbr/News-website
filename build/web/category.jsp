<%-- 
    Document   : category
    Created on : Jul 12, 2023, 11:05:17 AM
    Author     : MSI
--%>
                            ...
                            <div class="whats-news-wrapper">
                                ...
                                <script>
                                    function updateEndPage() {
                                        var activeTabHref = $(".nav-item.nav-link.active").attr("href");
                                        $.ajax({
                                            url: "/Assigment/category",
                                            ...
                                            success: function (data) {
                                                ...
                                                var newEndPage = parseInt(data, 10);
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                                                <div class="row">
                                                    <c:forEach var="a" items="${pagingShowbizArticle}">
                                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                                            <div class="whats-news-single mb-40 mb-40">
                                                                <div class="whates-img">
                                                                    <img src="${a.image}" alt="" style="width: 280px; height: 119px;">
                                            ...
                                            <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                                                <div class="row">
                                                    <c:forEach var="a" items="${pagingHealthArticle}">
                                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                                            <div class="whats-news-single mb-40 mb-40">
                                                                <div class="whates-img">
                                                                    <img src="${a.image}" alt="" style="width: 280px; height: 119px;">
                                            ...
                                            <div class="tab-pane fade" id="nav-last" role="tabpanel" aria-labelledby="nav-last-tab">
                                                <div class="row">
                                                    <c:forEach var="a" items="${pagingSportArticle}">
                                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                                            <div class="whats-news-single mb-40 mb-40">
                                                                <div class="whates-img">
                                                                    <img src="${a.image}" alt="" style="width: 280px; height: 119px;">
                                            ...
                                            <div class="tab-pane fade" id="nav-nav-Sport" role="tabpanel" aria-labelledby="nav-Sports">
                                                <div class="row">
                                                    <c:forEach var="a" items="${pagingTechnologyArticle}">
                                                        <div class="col-xl-6 col-lg-6 col-md-6">
                                                            <div class="whats-news-single mb-40 mb-40">
                                                                <div class="whates-img">
                                                                    <img src="${a.image}" alt="" style="width: 280px; height: 119px;">
