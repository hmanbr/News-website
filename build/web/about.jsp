<%-- 
    Document   : about
    Created on : Jul 12, 2023, 10:56:55 AM
    Author     : MSI
--%>
                    ...
                    <div class="row">
                        <div class="offset-xl-1 col-lg-8">
                            <div class="about-details-cap mb-50">
                                <h4>Our Mission</h4>
                                <p> Bringing you the most brain hurting, dramatic and annoying news you'll ever seen. 
                                </p>
                                <p> Also you can't sue us cause we are a ghost company based in Africa.</p>
                            </div>
                            <div class="about-details-cap mb-50">
                                <h4>Our Vision</h4>
                                <p>We plan to make every single person on earth have an aneurysm.
                                </p>
                                <p> You can't stop us, you can't look away, you can only watch.</p>
                            </div>
                        </div>
                    </div>
                </div>
