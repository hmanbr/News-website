<%-- 
    Document   : manage_admin_approved
    Created on : Aug 25, 2023, 2:25:51 AM
    Author     : MSI
--%>
            ...
            <section class="section">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Approved article</h5>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:forEach var="aaa" items="${allApproveArticles}">
                                            <tr>
                                                <th scope="row">${aaa.id}</th>
                                                    <c:forEach var="b" items="${authorList}">
                                                        <c:if test="${aaa.author_id eq b.id}">
                                                        <td>${b.name}</td>
                                                    </c:if>
                                                </c:forEach>
                                                <td>${aaa.title}</td>
                                                ...
                                                <td>${aaa.date}</td>
                                                <td>
                                                    <select id="statusSelect_${aaa.id}" class="badge bg-success" onchange="updateBadgeClass('statusSelect_${aaa.id}')">
...
<script>
                        ...
                        function categorizeRows() {
                            ...
                            rows.forEach(function (row) {
                                ...
                                var selectedValue = selectElement.value;
                                var aaaId = selectElement.id.split('_')[1]; // Extract the aaa.id from the id

                                if (selectedValue === "pending") {
                                    pArr.push(parseInt(aaaId));
                                } else if (selectedValue === "approved") {
                                    aArr.push(parseInt(aaaId));
                                } else if (selectedValue === "rejected") {
                                    rArr.push(parseInt(aaaId));
                                }
                            });
                            ...
                            inputManagePage.value = 'approved';
